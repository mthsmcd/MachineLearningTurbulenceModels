...
defineTypeNameAndDebug(nutRStress, 0);
addToRunTimeSelectionTable(RASModel, nutRStress, dictionary);

// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void nutRStress::correctNut()
{
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

nutRStress::nutRStress
(
